...
<div class="form-container">
	...
	<seael:elemset type="search" stylesheet="fields">
		...
		<seael:textfield label="product.label.spuName" name="spuName" cssClass="name" />
		<seael:multifields label="product.label.marketDate"><seael:datefield 
			name="marketDateFrom" format="date" cssClass="from" />-<seael:datefield 
			name="marketDateTo" format="date" cssClass="to" /></seael:multifields>
